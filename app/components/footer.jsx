...
export default function Footer() {
  return (
    <footer className="bg-black text-white border-t-white border-t-[1px]">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
          <div>
            <div className="flex justify-center text-[#f4c430] sm:justify-start text-4xl">
              Brand Logo
            </div>
          ...
          <div className="mt-8 space-y-4 lg:mt-0 col-span-2">
            ...
            <form className="mt-6 w-full">
              ...
              <div className="rounded-md border border-gray-100 p-2 focus-within:ring sm:flex sm:items-center sm:gap-4 bg-white">
                <input
                  type="email"
                  id="UserEmail"
                  placeholder="john@email.com"
                  className="w-full border-none focus:outline-none text-gray-500 focus:ring-transparent sm:text-sm text-lg"
                />
